...
export const metadata: Metadata = {
  ...
  description:
    "Digital art's emergent canon held by Hivemind Digital Culture Fund. Defining works by XCOPY, Tyler Hobbs, Dmitri Cherniak, Larva Labs, Refik Anadol, Sam Spratt, Kim Asendorf and more.",
  openGraph: {
