// Keyed by real collection slug (verified against data.ts). Renders only when a
// piece has no resolvable image, so it's a rare fallback — but the keys must
// match or every collection silently gets the gray default `D`. (plan A.5)
const P: Record<string, { bg: string; fg: string }> = {
  ...
  "winds-of-yawanawa":         { bg: "#E4EAEA", fg: "#88A8A8" },
  "synthetic-dreams":          { bg: "#E9E4EC", fg: "#9888A8" },
  "dataland-biome-lumina":     { bg: "#E4E7EA", fg: "#88A0B0" },
  "ack-editions":              { bg: "#E8E7E5", fg: "#A09890" },
  "notable-pepes":             { bg: "#E4EAE4", fg: "#88A088" },
  "superrare-beeple":          { bg: "#E7E7E5", fg: "#989890" },
  "superrare-dmitri-cherniak": { bg: "#E5E7EA", fg: "#8890A0" },
  lightyears:                  { bg: "#EAEAE8", fg: "#A8A8A0" },
  "pxl-dex":                   { bg: "#E4E8E4", fg: "#80A080" },
  "pxl-pod":                   { bg: "#E4E8E4", fg: "#80A080" },
  ...
  "masks-of-luci":             { bg: "#EBE6E3", fg: "#B89880" },
  "skulls-of-luci":            { bg: "#EBE6E3", fg: "#B89880" },
  "day-gardens":               { bg: "#E3EBE5", fg: "#80B088" },
  "tyler-hobbs":               { bg: "#EDE9E3", fg: "#C4A888" },
  qql:                         { bg: "#E8E5EB", fg: "#9888A0" },
  "superrare-xcopy":           { bg: "#EBE4E4", fg: "#C08888" },
};
