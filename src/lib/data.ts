...
export const collections: Collection[] = [
  ...
  },
  {
    ...
    name: 'Grifters',
    artistSlug: 'xcopy',
    description: 'XCOPY\'s 666-piece Grifters collection, minted in December 2021, is rich with cultural commentary and remains one of the most sought-after series of its era, revered for its symbolism, its collector community, and its place in XCOPY\'s broader universe.',
